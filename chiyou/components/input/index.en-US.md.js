(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components/input/index.en-US.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./components/input/index.en-US.md":
/*!*********************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./components/input/index.en-US.md ***!
  \*********************************************************************************************/
...
module.exports = {
  ...
  "api": [
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "td",
            "The size of the input box. Note: in the context of a form, the ",
            [
              "code",
              "large"
            ],
            " size is used. Available: ",
            [
              "code",
              "large"
            ],
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "td",
            "Height autosize feature, can be set to ",
            [
              "code",
              "true|false"
            ],
      ...
      [
        ...
        [
          ...
          [
            ...
            " specifies the size of the included ",
            [
              "code",
              "Input"
            ],
    ...
    [
      "h3",
      "Why Input lose focus when change ",
      [
        "code",
        "prefix/suffix"
      ]
    ...
    [
      "p",
      "When Input dynamic add or remove ",
      [
        "code",
        "prefix/suffix"
      ],
      " will make React recreate the dom structure and new input will be not focused. You can set an empty ",
      [
        "code",
        "<span />"
      ],
