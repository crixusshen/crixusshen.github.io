(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components/form/index.en-US.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./components/form/index.en-US.md":
/*!********************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./components/form/index.en-US.md ***!
  \********************************************************************************************/
...
module.exports = {
  "content": [
    ...
    [
      ...
      {
        "lang": "jsx",
        "highlighted": "<span class=\"token operator\">&lt;</span>Form<span class=\"token punctuation\">.</span>Item <span class=\"token punctuation\">{</span><span class=\"token operator\">...</span>props<span class=\"token punctuation\">}</span><span class=\"token operator\">></span><span class=\"token punctuation\">{</span>children<span class=\"token punctuation\">}</span><span class=\"token tag\"><span class=\"token tag\"><span class=\"token punctuation\">&lt;/</span>Form.Item</span><span class=\"token punctuation\">></span></span>"
      },
      [
        "code",
  ...
  "api": [
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "td",
            "(Added in 3.14.0. Previous version can only set on FormItem.) The layout of label. You can set ",
            [
              "code",
              "span"
            ],
        ...
        [
          ...
          [
            "td",
            "(Added in 3.14.0. Previous version can only set on FormItem.) The layout for input controls, same as ",
            [
              "code",
              "labelCol"
            ]
      ...
      [
        ...
        [
          ...
          [
            ...
            ". Please note that the form fields will become controlled components. Properties like errors will not be automatically mapped and need to be manually passed in."
          ],
          [
            "td",
            "(props) => ({ ",
        ...
        [
          ...
          [
            "td",
            "Set the id prefix of fields under form"
          ],
          [
            "td",
            "-"
        ...
        [
          ...
          [
            "td",
            "Specify a function that will be called when the fields (including errors) of a ",
            [
              "code",
              "Form.Item"
            ],
        ...
        [
          ...
          [
            ...
            [
              ...
              " internally, we recommend to use variable as ",
              [
                "code",
                "initialValue"
              ],
      ...
      [
        ...
        [
          ...
          [
            ...
            ". You can set on Form one time after 3.14.0. Will take FormItem's prop when both set with Form."
          ],
          [
            "td",
            [
    ...
    [
      ...
      " with some error that ",
      [
        "code",
        "callback"
      ],
      " can not be called. You can use ",
      [
        "code",
        "async"
      ],
