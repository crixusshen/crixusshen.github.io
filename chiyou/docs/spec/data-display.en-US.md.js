(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs/spec/data-display.en-US.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./docs/spec/data-display.en-US.md":
/*!*********************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./docs/spec/data-display.en-US.md ***!
  \*********************************************************************************************/
...
module.exports = {
    ...
    [
      ...
      [
        "img",
        {
          ...
          "align": "right",
          "src": "https://gw.alipayobjects.com/zos/rmsportal/PetAXSByOolFbtmLazQz.png"
        }
      ]
    ],
    [
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "p",
            "The time, status, and action bar in the table need to keep the words intact without occupying multiple lines."
          ]
        ],
        [
          "li",
          [
            "p",
            "When the data is empty, use \"- -\" to indicate that there is no data."
          ]
        ]
      ]
    ],
    ...
    [
      ...
      [
        "img",
        {
          "class": "preview-img no-padding",
          "align": "right",
          "src": "https://gw.alipayobjects.com/zos/rmsportal/ypeOSafZJYqVJUHcJeef.png"
        }
      ]
    ],
    [
    ...
    [
      ...
      [
        "img",
        {
          "class": "preview-img no-padding",
          "align": "right",
          "src": "https://gw.alipayobjects.com/zos/rmsportal/xtIGZmqUHAovPPKjwyVT.png",
          "description": "If the content of the page is too slow, you can use \"preload\" or \"step-by-step\" to alleviate the user's anxiety during waiting time."
        }
      ]
    ],
    [
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "p",
            "Cards are usually arranged according to the grid, and a maximum of four lines is recommended."
          ]
        ],
        [
          "li",
          [
            "p",
            "In the limited card space, you need to pay attention to the spacing between the information. If the information is too long, you can cut off the information. For example, \"Ant Design is suitable for the middle station...\""
          ]
        ]
      ]
    ],
    ...
    [
      ...
      [
        "img",
        {
          "class": "preview-img no-padding",
          "align": "right",
          "src": "https://gw.alipayobjects.com/zos/rmsportal/FaAbGkTwlhykSDSBqWbW.png"
        }
      ]
    ],
    [
    ...
    [
      ...
      [
        ...
        [
          ...
          [
            "p",
            "The number of carousels should not be too much to avoid user boredom, it is best to control between 3 and 5."
          ]
        ],
        [
          "li",
          [
            "p",
            "It is recommended to provide hints on the design to allow users to maintain a clear understanding of the number and direction of the carousel."
          ]
        ]
      ]
    ],
    ...
    [
      ...
      [
        "img",
        {
          "class": "preview-img no-padding",
          "align": "right",
          "src": "https://gw.alipayobjects.com/zos/rmsportal/QZyxnLWUkbIuTqGYxTQs.png"
        }
      ]
    ],
    [
    ...
    [
      ...
      [
        "img",
        {
          "class": "preview-img no-padding",
          "align": "right",
          "src": "https://gw.alipayobjects.com/zos/rmsportal/WmQeylAyWUNKmQIyoQGH.png"
        }
      ]
    ],
    [
  ...
  "meta": {
    ...
    "order": 10,
    "title": "Data Display",
    "filename": "docs/spec/data-display.en-US.md"
  },
  "description": [
    "section",
    [
...
//# sourceMappingURL=data-display.en-US.md.js.map