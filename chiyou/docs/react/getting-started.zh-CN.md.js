(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs/react/getting-started.zh-CN.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/getting-started.zh-CN.md":
/*!*************************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/getting-started.zh-CN.md ***!
  \*************************************************************************************************/
...
module.exports = {
  "content": [
    ...
    [
      ...
      " 创建一个 codesandbox 的在线示例，别忘了保存以创建一个新的实例。"
    ],
    [
      "h3",
      "2. 使用组件"
    ...
    [
      ...
      [
        ...
        {
          "title": null,
          "href": "/components/alert-cn"
        },
        "Alert"
      ],
      " 组件，组件文档中提供了各类演示，最下方有组件 API 文档可以查阅。在代码演示部分找到第一个例子，点击右下角的图标展开代码。"
    ],
    [
      "p",
      "然后依照演示代码的写法，在之前的 codesandbox 里修改 ",
      [
        "code",
        "index.js"
      ],
    ...
    [
      ...
      {
        "lang": "diff",
        "highlighted": "<span class=\"token deleted\">- import { ConfigProvider, DatePicker, message } from 'antd';</span>\n<span class=\"token inserted\">+ import { ConfigProvider, DatePicker, message, Alert } from 'antd';</span>"
      },
      [
        "code",
    ...
    [
      ...
      [
        ...
        {
          "width": "420",
          "src": "https://gw.alipayobjects.com/zos/antfincdn/Up3%24VYhN0S/134614ee-7440-46f1-a797-fa6f6b3e300f.png",
    ...
    [
      ...
      [
        ...
        {
          "title": null,
          "href": "https://umijs.org/zh/config/#targets"
        },
        "targets"
      ],
      " 配置。"
    ...
    [
      ...
      {
        "lang": "jsx",
        "highlighted": "<span class=\"token keyword\">import</span> Button <span class=\"token keyword\">from</span> <span class=\"token string\">'antd/es/button'</span><span class=\"token punctuation\">;</span>\n<span class=\"token keyword\">import</span> <span class=\"token string\">'antd/es/button/style'</span><span class=\"token punctuation\">;</span> <span class=\"token comment\" spellcheck=\"true\">// 或者 antd/es/button/style/css 加载 css 文件</span>"
      },
      [
        "code",
    ...
    [
      ...
      [
        ...
        " 属性除了引入对应组件的样式，也会引入一些必要的全局样式。如果你不需要它们，建议不要使用此属性。你可以 ",
        [
          "code",
          "import 'antd/dist/antd.css'"
        ],
    ...
    [
      ...
      " 插件用 Day.js 替换 momentjs 来大幅减小打包大小。这需要更新 webpack 的配置文件如下："
    ],
    [
      "pre",
      {
