(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs/react/getting-started.en-US.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/getting-started.en-US.md":
/*!*************************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/getting-started.en-US.md ***!
  \*************************************************************************************************/
...
module.exports = {
  "content": [
    ...
    [
      "iframe",
      {
        ...
        "style": "width: 100%; height: 500px; border: 0px; border-radius: 4px; overflow: hidden;",
    ...
    [
      ...
      [
        ...
        {
          "title": null,
          "href": "http://u.ant.design/codesandbox-repro"
        },
        "http://u.ant.design/codesandbox-repro"
      ],
      " to create a codesandbox. Don't forget to press the save button."
    ],
    [
      "h3",
    ...
    [
      "p",
      "If you already set up by ",
      [
        "a",
        {
          "title": null,
          "href": "https://ant.design/docs/react/use-with-create-react-app#Install-and-Initialization"
        },
        "Install and Initialization"
      ],
      " section of \"Use in create-react-app\", Please replace the content of /src/index.js"
    ],
    [
      "pre",
      {
    ...
    [
      "p",
      "You can look up components in the side menu like the ",
      [
        "a",
        {
          "title": null,
      ...
      " component. Plenty of examples are provided in the component pages and API documentation."
    ],
    [
      "p",
      "Click the \"Open in Editor\" icon in the first example to open an editor with source code to use out-of-the-box. Now you can import the ",
      [
        "code",
        "Alert"
      ],
    ...
    [
      ...
      {
        "lang": "diff",
        "highlighted": "<span class=\"token deleted\">- import { DatePicker, message } from 'antd';</span>\n<span class=\"token inserted\">+ import { DatePicker, message, Alert } from 'antd';</span>"
      },
      [
        "code",
    ...
    [
      "p",
      "Add the following jsx into the ",
      [
        "code",
        "render"
      ],
    ...
    [
      ...
      [
        ...
        {
          "width": "420",
          "src": "https://gw.alipayobjects.com/zos/antfincdn/QjCr7oLcpT/c7ce72d2-601e-4130-a33b-456d4652bb2d.png",
    ...
    [
      "p",
      "In the real world you will need a development workflow consisting of ",
      [
        "code",
        "compile/build/deploy/lint/debug"
      ],
      ". You can find and read articles on the subject or try other scaffolds provided below:"
    ],
    [
      "ul",
      [
    ...
    [
      "p",
      "If you want to customize your work flow, we recommend using ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      " available in the React ecosystem. If you encounter problems, you can use our ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        {
          "title": null,
          "href": "https://github.com/ant-design/parcel-antd"
        },
        "a demo repository"
      ],
      "."
    ...
    [
      ...
      " which have already integrated antd, so you can try and start with one of these and even contribute."
    ],
    [
      "h2",
      "Import on Demand"
    ...
    [
      "p",
      "If you see logs like in the screenshot below, you might be importing all components by writing ",
      [
        "code",
    ...
    [
      ...
      {
        "lang": "jsx",
        "highlighted": "<span class=\"token keyword\">import</span> Button <span class=\"token keyword\">from</span> <span class=\"token string\">'antd/es/button'</span><span class=\"token punctuation\">;</span>\n<span class=\"token keyword\">import</span> <span class=\"token string\">'antd/es/button/style'</span><span class=\"token punctuation\">;</span> <span class=\"token comment\" spellcheck=\"true\">// or antd/es/button/style/css for css format file</span>"
      },
      [
        "code",
    ...
    [
      ...
      [
        "p",
        "Note: antd supports ES6 tree shaking, so ",
        [
          "code",
          "import { Button } from 'antd';"
        ],
        " will drop the js code you don't use too."
      ]
    ],
    [
      "p",
      ...
      ", which can convert the following code to the 'antd/es/xxx' way:"
    ],
    [
      "pre",
      {
    ...
    [
      "p",
      "And this plugin can load styles too. Read ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        " option will importing some global reset styles, don't use it if you don't need those styles. You can import styles manually via ",
        [
          "code",
          "import 'antd/dist/antd.css'"
        ],
    ...
    [
      ...
      " plugin to replace momentjs to Day.js to reduce bundle size dramatically. You need to update your webpack config file like this:"
    ],
    [
      "pre",
      {
  ...
  "description": [
    ...
    [
      "p",
      "Ant Design React is dedicated to providing a ",
      [
        "strong",
        "good development experience"
      ],
      " for programmers. Make sure that you have installed ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "If you try in local environment, Please refer to ",
      [
        "a",
        {
          "title": null,
      ...
      " section of \"Use in create-react-app\"."
    ],
    [
      "blockquote",
      [
        "p",
        "Before delving into Ant Design React, a good knowledge base of ",
        [
          "a",
          {
            "title": null,
  ...
  "toc": [
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Replace-momentjs-to-Day.js",
          "title": "Replace momentjs to Day.js"
        },
        "Replace momentjs to Day.js"
      ]
    ],
