(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs/react/faq.en-US.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/faq.en-US.md":
/*!*************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/faq.en-US.md ***!
  \*************************************************************************************/
...
module.exports = {
  "content": [
    ...
    [
      ...
      ". If you're using an older version, you can use ",
      [
        "code",
        "<Select getPopupContainer={trigger => trigger.parentNode}>"
      ],
      " to render a component inside Popover. (Or other ",
      [
        "code",
        "getXxxxContainer"
      ],
    ...
    [
      ...
      ") to render a component inside the scroll area. If you need to config this globally in your application, try ",
      [
        "code",
      ...
      [
        ...
        {
          "title": null,
          "href": "https://ant.design/components/config-provider-cn/#API"
        },
        "API reference"
      ],
      ")"
    ...
    [
      "p",
      "No, we follow Ant Design specification. ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      "(etc.), but it seems that I have to import the whole of antd and its style."
    ],
    [
      "p",
      "Try ",
      ...
      ", or import what you need in this way:"
    ],
    [
      "pre",
      {
        "lang": "jsx",
        "highlighted": "<span class=\"token keyword\">import</span> Menu <span class=\"token keyword\">from</span> <span class=\"token string\">'antd/es/menu'</span><span class=\"token punctuation\">;</span>\n<span class=\"token keyword\">import</span> <span class=\"token string\">'antd/es/menu/style/css'</span><span class=\"token punctuation\">;</span>"
      },
      [
        "code",
    ...
    [
      ...
      " directly without changing a line of existing code. More info at ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      "(etc...) only works on the first render. It is a specification of React. Please read ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "Yes, antd is designed to develop a complete background application, we override some global styles for styling convenience, and it can't be removed now. More info at ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "Long live the Girl Friend Wall! And try ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      " has not been optimized to do so. You may try ",
      [
        "a",
        {
          "title": null,
      ...
      ", those repositories which start with 'm-' 'rn-' are designed for mobile."
    ],
    [
      "h3",
      "Does ",
    ...
    [
      "p",
      "You should deploy the iconfont files to your network by following this ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        "we are using svg icon"
      ],
      ", so you don't need to deploy iconfont locally anymore."
    ],
    [
      "h3",
    ...
    [
      "p",
      "If you need some features which should not be included in antd, try to extend antd's component with ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        {
          "title": null,
          "href": "/components/config-provider/#Content-Security-Policy"
        },
        "ConfigProvider"
      ],
      "."
    ...
    [
      ...
      " to DatePicker/RangePicker, I cannot select year or month anymore?"
    ],
    [
      "p",
      "In a real world development, you may need a YearPicker, MonthRangePicker or WeekRangePicker. You are trying to add ",
      [
        "code",
        "mode"
      ],
      " to DatePicker/RangePicker expected to implement those pickers. However, the DatePicker/RangePicker cannot be selected and the panels won't close now."
    ],
    [
      "ul",
      [
        ...
        [
          ...
          [
            ...
            {
              "title": null,
              "href": "https://codesandbox.io/s/dank-brook-v1csy"
            },
            "https://codesandbox.io/s/dank-brook-v1csy"
          ]
        ]
      ],
      [
        ...
        [
          ...
          [
            ...
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design/issues/15572"
            },
            "#15572"
          ],
          ", ",
          [
            ...
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design/issues/16436"
            },
            "#16436"
          ],
          ", ",
          [
            ...
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design/issues/11938"
            },
            "#11938"
          ],
          ", ",
          [
            ...
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design/issues/11735"
            },
            "#11735"
          ],
          ", ",
          [
            ...
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design/issues/11586"
            },
            "#11586"
          ],
          ", ",
          [
            ...
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design/issues/10425"
            },
            "#10425"
          ],
          ", ",
          [
            ...
            {
              "title": null,
              "href": "https://github.com/ant-design/ant-design/issues/11053"
            },
            "#11053"
          ]
        ]
    ...
    [
      ...
      [
        ...
        {
          "title": null,
          "href": "https://github.com/ant-design/ant-design/issues/11586#issuecomment-429189877"
        },
        "the explaination"
      ],
      " here, that is because ",
      [
        "code",
      ...
      [
        ...
        "showing time picker panel in DatePicker"
      ],
      " in antd 3.0, which simply control the displayed panel and won't change the original date picking behavior of ",
      [
        "code",
        "DatePicker/RangePicker"
      ],
      " (for instance you still need to click date cell to finish selection in a DatePicker, whatever the ",
      [
        "code",
        "mode"
      ],
    ...
    [
      ...
      [
        ...
        {
          "title": null,
          "href": "https://juejin.im/post/5cf65c366fb9a07eca6968f9"
        },
        "this article"
      ],
      " or ",
      ...
      " for your needs. Or you can wait for our ",
      [
        "a",
        {
          "title": null,
          "href": "https://github.com/ant-design/ant-design/issues/16911"
        },
        "antd@4.0"
      ],
      ", in which we are planing to ",
      [
        "a",
        {
          "title": null,
          "href": "https://github.com/ant-design/ant-design/issues/4524#issuecomment-480576884"
        },
        "add more XxxPickers"
      ],
    ...
    [
      ...
      [
        ...
        [
          ...
          ": Capitalized with space, for the design language."
        ]
      ],
      [
        "li",
        [
          ...
          ": all lowercase, for the React UI library."
        ]
      ],
      [
        "li",
    ...
    [
      ...
      "'s components correctly. Read the corresponding documentation of the ",
      [
        "code",
        "antd"
      ],
    ...
    [
      "p",
      "Please read the corresponding documentation of the ",
      [
        "code",
        "antd"
      ],
      "'s version which you use, and make sure that you pass values with correct type to ",
      [
        "code",
        "antd"
      ],
    ...
    [
      "p",
      "You may import React twice. Set React & ReactDOM as external, if you are using webpack, See ",
      [
        "a",
        {
          "title": null,
      ...
      ". If you are using others (browserify, etc...), please read its documentation and find options which can set React & ReactDOM as external."
    ]
  ],
  "meta": {
    "order": 9,
    "title": "FAQ",
    "filename": "docs/react/faq.en-US.md"
  },
  "description": [
    "section",
    [
      "p",
      "Here are the frequently asked questions about Ant Design and antd that you should look up before you ask in the community or create a new issue. We also maintain a ",
      [
        "a",
        {
          "title": null,
          "href": "http://u.ant.design/faq"
        },
        "FAQ issues label"
      ],
      " for common github issues."
    ]
  ],
  "toc": [
    "ul",
...
//# sourceMappingURL=faq.en-US.md.js.map