(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs/react/contributing.en-US.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/contributing.en-US.md":
/*!**********************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/contributing.en-US.md ***!
  \**********************************************************************************************/
...
module.exports = {
  "content": [
    ...
    [
      ...
      " for bug tracking. The best way to get your bug fixed is using our ",
      [
        "a",
        {
          "title": null,
      ...
      " and provide reproduction steps with this ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "Before you report a bug, please make sure you've searched exists issues, and read our ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "If you intend to change the public API or introduce new feature, we also recommend you use our ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "If you want to help on new API, please reference ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        [
          ...
          " and commit these changes as well (if there are any updates)."
        ]
      ],
      [
        "li",
    ...
    [
      "p",
      "Since antd's components are based on react-component, sometimes you may need to send pull request to the corresponding react-component repository. If it's a bugfix pull request, after it's merged, the core team will release a patch release for that component as soon as possible, then you only need to reinstall antd in your project to get the latest patch release. If it's a feature pull request, after it's merged, the core team will release a minor release, then you need raise another pull request to ",
      [
        "a",
        {
          "title": null,
...
//# sourceMappingURL=contributing.en-US.md.js.map