(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["docs/react/use-with-create-react-app.en-US.md"],{

/***/ "./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/use-with-create-react-app.en-US.md":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/bisheng/lib/loaders/source-loader.js!./docs/react/use-with-create-react-app.en-US.md ***!
  \***********************************************************************************************************/
...
module.exports = {
  "content": [
    ...
    [
      "p",
      "Ok, you should now see a blue primary button displayed on the page. Next you can choose any components of ",
      [
        "code",
        "antd"
      ],
    ...
    [
      ...
      " plugin to replace momentjs to Day.js to reduce bundle size dramatically."
    ],
    [
      "pre",
      {
    ...
    [
      "p",
      "You can also eject your application using ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "Finally, we used antd with create-react-app successfully, you can learn these practices for your own webpack workflow too, and find more webpack configs in the ",
      [
        "a",
        {
          "title": null,
      ...
      " to avoid loading all language files.)"
    ],
    [
      "p",
  ...
  "description": [
    ...
    [
      ...
      " is one of the best React application development tools. We are going to use ",
      [
        "code",
        "antd"
      ],
  ...
  "toc": [
    ...
    [
      ...
      [
        ...
        {
          "className": "bisheng-toc-h2",
          "href": "#Source-code-and-other-boilerplates",
          "title": "Source code and other boilerplates"
        },
        "Source code and other boilerplates"
      ]
    ]
...
//# sourceMappingURL=use-with-create-react-app.en-US.md.js.map